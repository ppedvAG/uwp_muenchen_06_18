...
namespace BooksToDo.Helpers
{
    ...
    public static class SettingsStorageExtensions
    {
        ...
        public static void SaveString(this ApplicationDataContainer settings, string key, string value)
        {
            ...
            int zahl = (554).BildeQuersummy();
        }

        public static string ReadString(this ApplicationDataContainer settings, string key, string value)
        {
        ...
        public static int BildeQuersummy(this int z)
        {
            int summe = 0;
            string alsString = z.ToString();
            foreach (var item in alsString)
            {
                summe += Convert.ToInt32(item);
            }
            return summe;
        }
